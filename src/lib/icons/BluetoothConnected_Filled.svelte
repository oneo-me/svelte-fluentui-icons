...
<IconBase
    title="BluetoothConnected_Filled"
    viewBox="0 0 20 20"
    data="M10.28 2.22A.75.75 0 0 0 9 2.75v5.674L6.223 6.168a.75.75 0 1 0-.946 1.164L8.561 10l-3.284 2.668a.75.75 0 0 0 .946 1.164L9 11.576v5.674a.75.75 0 0 0 1.28.53l4-4a.75.75 0 0 0-.057-1.112L10.939 10l3.284-2.668a.75.75 0 0 0 .057-1.112l-4-4Zm.22 13.22v-3.864l2.132 1.732-2.132 2.131Zm2.132-8.748L10.5 8.424V4.561l2.132 2.131ZM4 10a1 1 0 1 1-2 0 1 1 0 0 1 2 0Zm13 0a1 1 0 1 1-2 0 1 1 0 0 1 2 0Z M 0 0 M 20 20"
    {...others}
/>
